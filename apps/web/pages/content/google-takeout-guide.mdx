...
<MetaDescription content="Use Google Takeout to export your Google Photos library." />
...
> You may be tempted to select **2GB** files instead of **50GB**. That's fine, but you could end up having to **manage hundreds of downloads**. It can get extremely tedious for large libraries
  ...
  ![Deselect all](/images/content/google-takeout-guide/deselect-all.png) 
  
  ![Select
  photos](/images/content/google-takeout-guide/select-photos.png) 
  
  ![Next step](/images/content/google-takeout-guide/next-step.png)
  
  ![Export selections](/images/content/google-takeout-guide/export-selections.png) 
...
When the files are ready, you'll click `Manage exports` and then you'll download each individual file.
  ...
  ![Manage exports](/images/content/google-takeout-guide/manage-exports.png) 
  
  ![Download files](/images/content/google-takeout-guide/download-files.png)
...
![Google Photos Takeout Helper](/images/content/google-takeout-guide/google-photos-takeout-helper.png) 
