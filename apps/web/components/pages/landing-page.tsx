...
import { GetStarted, Image, Link, LogInOrContinue, PhoneBorder, Video } from 'ui/components';
...
export function LandingPage() {
  return (
    <>
      <Head>
        <meta
          content='Export Google Photos to a hard drive. Archive or migrate your Google Photos library.'
          name='description'
        />
      </Head>
      <Box
      ...
      >
        ...
        >
          <Image
            ...
            style={{ objectFit: 'cover', width: 'auto', height: 'auto', maxWidth: 'calc(100vw - 1rem)' }}
            width={800}
          />
          <Typography
            sx={{
        ...
        <TwoColumn>
          ...
          <Typography>
            ...
            <br />
            Granted, they&apos;ve provided an export mechanism via Google Takeout that works &quot;ok&quot;, but it has
            a bad habit of stripping date metadata, so the next time you try to sort your images by date....
            <br />
        ...
        <TwoColumn>
          ...
          <Typography sx={{ maxWidth: '400px' }} variant='body1'>
            ...
            <br />
            <b>1.</b> The Desktop App ingests your photo and video (aka &quot;media item&quot;) records from the Web
            App.
            <br />
            <b>2.</b> Next, the Desktop App starts downloading your &quot;media items&quot;. It tags the files with
            their Google Photos ID. This ID prevents the Desktop App from downloading the same file twice.
            <br />
            <b>3.</b> When the Desktop App restarts, it quickly indexes existing files on your hard drive to see what
            has already been downloaded. It maintains local records on your filesystem of every file that has been
            downloaded. If it finds an new file, it first checks to see if it has a Google Photos ID. If so, it can
            safely skip downloading that file. This process enables you to start and stop the Desktop App as needed. It
            won&apos;t download files twice.
          </Typography>
        </TwoColumn>
        ...
        <Typography>
          We&apos;ll happily issue a full refund if you&apos;re not satisfied with Quiver Photos. We learned long ago
          that nobody likes being an unhappy customer! We hate being unhappy customers. You hate being unhappy
          customers. EVERYONE HATES IT!!!! ARG!!!
          <br />
    ...
    >
      ...
      >
        ...
        <Image
          ...
          src='/images/windows-explorer.png'
        />
      </Box>
    </Box>
  );
